...
// String baseUrl = "https://hamarakisan-backend.onrender.com";

// Endpoints
String getTableDataEndpoint = "$baseUrl/getTableData";
String getHomePageGraphsEndpoint = "$baseUrl/homepagegraphs";
String getDashboardGraphsEndpoint = "$baseUrl/dashboardgraphs";
String getMainGraphEndpoint = "$baseUrl/maingraph";
String pinMandiTableEndpoint = "$baseUrl/pinnedmanditable";
...
String deleteRecordEnpoint = "$baseUrl/deleteRecord";
